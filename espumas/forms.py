...
class medidasForm(forms.ModelForm):
    class Meta:
        model = BloqueMedidas
        fields = ['tipo_de_espuma','tipo_de_unidad','forma','medida_dispobible','descripcion','ancho_frio_objetivo','largo_frio_objetivo','alto_frio_objetivo','ancho_caliente_setting_predefinido','largo_caliente_setting_predefinido','alto_caliente_setting_predefinido','uso_objetivo',]
        widgets = {
...
class tdeForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['tipo_de_espuma','formulacion_o_clave','multiplicador','precio','familia','densidad_descripcion','densidad_objetivo_minima','densidad_objetivo_maxima','dureza_objetivo_minima','dureza_objetivo_maxima','retardante_flama','anti_bacterial','anti_estatica','color','elongacion','histasis','sag_factor','disponible']
        widgets = {
